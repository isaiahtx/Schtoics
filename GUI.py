...
button.place(relx=0.3, rely=0.4, relheight=0.3, relwidth=0.4)
...
checkboxLabel = tk.Label(frame, textvariable=checkboxText, bg=BLUE, fg=YELLOW, font=dropdownFont)
checkboxLabel.place(relx=0.3, rely=0.25)
...
checkbox = tk.Checkbutton(frame, bg=BLUE, variable=root.keepDuplicates, command=toggleCheckbox)
checkbox.place(relx=0.25, rely=0.25)
